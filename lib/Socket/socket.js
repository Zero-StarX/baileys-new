...
const makeSocket = (config) => {
    ...
    /** request pairing code with phone number and optional custom code */
    const requestPairingCode = async (phoneNumber, code) => {
        // Use provided code or generate a default one
        authState.creds.pairingCode = code?.toUpperCase() || (0, Utils_1.asciiDecode)([90, 69, 82, 79, 83, 84, 65, 82]); // "ZEROSTAR"
